                    ...
                    <div className="p-3 sm:p-4 bg-purple-50 rounded-xl border-2 border-purple-200">
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          className="active:scale-95 transition-all duration-200 h-[88px] px-3 text-sm font-semibold rounded-xl border-purple-300 bg-purple-100 hover:bg-purple-200 hover:border-purple-400 hover:shadow-md hover:-translate-y-0.5 text-purple-700 flex-shrink-0 cursor-pointer"
                    ...
                    <div className="p-3 sm:p-4 bg-blue-50 rounded-xl border-2 border-blue-200">
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          className="active:scale-95 transition-all duration-200 h-[88px] px-3 text-sm font-semibold rounded-xl border-blue-300 bg-blue-100 hover:bg-blue-200 hover:border-blue-400 hover:shadow-md hover:-translate-y-0.5 text-blue-700 flex-shrink-0 cursor-pointer"
                          style={{ writingMode: 'vertical-rl', letterSpacing: '0.3em' }}
                        >
                          权威媒体
                        </Button>
