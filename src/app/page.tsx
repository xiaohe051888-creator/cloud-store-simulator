                  ...
                  <div className="p-3 sm:p-5 bg-white border-t border-purple-200">
                    ...
                    <div className="mt-3 p-3 sm:p-4 bg-purple-50 border-2 border-purple-200 rounded-xl">
                      ...
                      <p className="text-sm sm:text-base text-gray-700">
                        奖励 = 自己的社区等级 <span className="text-xl sm:text-2xl font-bold text-purple-600 mx-1">-</span> 直属的社区等级对应的百分比差额 <span className="text-xl sm:text-2xl font-bold text-purple-600 mx-1">×</span> 团队成员店铺代缴结算的金额，<span className="font-bold text-red-600">平级无奖励</span>
                      </p>
                    </div>
                  </div>
                )}
